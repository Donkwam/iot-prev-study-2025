...
def load_contact(lst_contact):
    ...
    while True:
        line = f.readline() # 명건/7732/naver.com/부산
        if not line:
...
if __name__ == '__main__':
    ...
    print('주소록 프로그램')
    # 3. 클래스 실행 - 객체를 생성
    # first = contact.Contact('유고 성', '010-6683-7732', 'personar95@naver.com', '부산')
    # print(first)
    run() # 제일 처음 실행되는 함수
